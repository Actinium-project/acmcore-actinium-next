...
To download Actinium Core, visit [litecoin.org](https://actinium.org).
...
* See the documentation at the [Actinium Wiki](https://litecoin.info/)
...
* Discuss general Actinium development on #litecoin-dev on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=litecoin-dev).

...
* litecoin.conf: contains configuration settings for Actiniumd or Actinium-Qt
* Actiniumd.pid: stores the process id of Actiniumd while running
...
* debug.log: contains debug information and general logging generated by Actiniumd or Actinium-Qt

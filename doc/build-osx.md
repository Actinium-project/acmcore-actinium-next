...
1. Clone the litecoin source code and cd into `litecoin`
        ...
        git clone https://github.com/Actinium-project/litecoin
        cd litecoin
...
Before running, it's recommended you create an RPC configuration file.
    ...
    echo -e "rpcuser=litecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Actinium/litecoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Actinium/litecoin.conf"
...
-------
    ...
    ./src/Actiniumd -daemon # Starts the litecoin daemon.

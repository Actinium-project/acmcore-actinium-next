...
Actinium Core automatically creates a hidden service to listen on, without
manual configuration. Actinium Core will also use Tor automatically to connect

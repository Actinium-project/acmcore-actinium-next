...
class BitcoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--usecli", dest="usecli", default=False, action="store_true",
                          help="use Actinium-cli instead of RPC for all commands")
    ...
    def stop_node(self, i):
        """Stop a Actiniumd test node"""
        self.nodes[i].stop_node()
        self.nodes[i].wait_until_stopped()

    def stop_nodes(self):
        """Stop multiple Actiniumd test nodes"""
        for node in self.nodes:
    ...
    def _initialize_chain(self):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                args = [os.getenv("LITECOIND", "Actiniumd"), "-server", "-keypool=1", "-datadir=" + datadir, "-discover=0"]
                if i > 0:
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("LITECOIND", "Actiniumd"),

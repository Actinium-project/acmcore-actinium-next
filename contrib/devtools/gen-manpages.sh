...
LITECOIND=${LITECOIND:-$SRCDIR/Actiniumd}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/Actinium-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/Actinium-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/Actinium-Qt}
